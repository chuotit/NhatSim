...
namespace NhatSim.Web.App_Start
{
    ...
    {
        public ApplicationUserStore(NhatSimDbContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<NhatSimDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<NhatSimDbContext>()));
